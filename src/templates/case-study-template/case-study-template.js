              ...
              <Row justify="center">
                <Col lg={10}>
                  <BannerTextWrap>
                    {pageData.logo && (
                      <Img
                        fixed={pageData.logo.childImageSharp.fixed}
                        alt={pageData.title}
                      />
                    )}
                    {pageData.tagline && (
          ...
          <OverviewArea>
            <Container>
              ...
              <Row>
                <Col lg={5}>
                  {overview.heading && (
                    <Heading {...overviewHeading}>{overview.heading}</Heading>
                  )}
                  {overview.client && (
                    <ClientBox>
                  ...
                  <Row>
                    <Col md={4}>
                      <ProblemTextBox>
                        <Icon
                          {...problemIcon}
                          iconName="fal fa-long-arrow-right"
                        />
                ...
                {video && (
                  <Col lg={6}>
                    <VideoBoxWrap>
                      {video.preview_image && (
                        <Image
                          fluid={video.preview_image.childImageSharp.fluid}
                          alt="Video preview"
                          align="left"
                        />
                      )}
