            ...
            <Container>
              <Row justify="center">
                <Col lg={8}>
                  <BannerTextWrap>
                    {pageData.title && (
                      <Heading {...titleStyle}>{pageData.title}</Heading>
                    )}
                    {pageData.tagline && (
                      <Heading {...taglineStyle}>{pageData.tagline}</Heading>
                    )}
                  </BannerTextWrap>
                </Col>
              </Row>
              ...
              <Row>
                ...
                {pageData.introText && (
                  <Col lg={{ span: 7, offset: 1 }}>
                    <Box>
                      {pageData.introText.heading && (
                        <Heading {...rightHeading}>
                          {parse(pageData.introText.heading)}
                        </Heading>
                      )}
                      {pageData.introText.text && (
                        <Text {...rightText}>
                          {parse(pageData.introText.text)}
                        </Text>
                      )}
                    </Box>
                  </Col>
            ...
            <Container>
              <Row>
                ...
                {pageData.video && (
                  <Col lg={6}>
                    <VideoBoxWrap>
                      {pageData.video.preview_image && (
                        <Image
                          fluid={
                            pageData.video.preview_image.childImageSharp.fluid
                          }
                          alt="Video preview"
                          align="left"
                        />
