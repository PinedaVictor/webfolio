...
const ButtonStyled = css`
        ...
        ${(props) =>
          ...
          css`
            ...
            border-bottom-style: ${(props) =>
              props.border.bottom.style || "solid"};
            border-bottom-color: ${(props) =>
              props.border.bottom.color || props.theme.colors.borderColor};
          `}
      `};
    @media ${device.xsmall}{
        ${(props) =>
    ...
    ${(props) =>
      ...
      css`
        ...
        background: ${(props) =>
          props.bgcolor || props.theme.colors.themeColor};
        &:hover{
            color: ${(props) => props.color || props.theme.colors.white};
        }
        ${(props) =>
    ...
    ${(props) =>
      ...
      css`
        ...
        border-color: ${(props) =>
          props.bordercolor || props.theme.colors.themeColor};
        border-width: ${(props) => props.borderwidth};
        ${(props) =>
          props.skin === "primary" &&
          css`
